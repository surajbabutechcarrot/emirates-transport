...
<footer class="footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 order-md-2 order-2 pt-0 pt-lg-0 pt-4 order-lg-1">
                <p>جميع الحقوق محفوظة لمواصلات الإمارات © 2024</p>
            </div>
            ...
            <ul class="social d-flex align-items-center">
                    ...
                    <li><a target="_blank" href="https://www.facebook.com/share/ketiEZLNAm24f5cD/?mibextid=qi2Omg"><svg id="Layer_2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13.67 27.82">
                                <defs>
                                    <style>
                                        .cls-1 {
                                            fill: #fff;
    ...
    <script src="<?php echo $path; ?>assets/js/l-scroll.js"></script>
    <!-- Lazyload -->
    <script src="<?php echo $path; ?>assets/js/vendors/lazyload-all.js" async=""></script>
    <script src="<?php echo $path; ?>assets/js/vendors/slick.min.js"></script>

    <!-- tweenmax animation -->
    <!-- <script type="text/javascript" src="<?php echo $path; ?>assets/js/TweenMax.min.js"></script>
    <script type="text/javascript" src="<?php echo $path; ?>assets/js/ScrollMagic.js"></script>
    <script type="text/javascript" src="<?php echo $path; ?>assets/js/animation.gsap.min.js"></script>
