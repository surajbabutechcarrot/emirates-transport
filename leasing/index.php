        ...
        <div class="service-wrap container std-space">
            ...
            <div class="row h-100 mt-md-5 mb-4 mb-md-0 pt-md-4">
                ...
                <div class="col-md-3 my-auto">
                    <h2 class="text-black fw-bold mb-4">FLEET LEASING & MANAGEMENT</h2>
            ...
            <div class="row h-100 mt-md-5 mb-4 mb-md-0">
                <div class="col-md-5 my-auto">
                    <h2 class="text-black fw-bold text-uppercase mb-4">Solutions for Every <br>Journey</h2>
        ...
        <div class="container">
            <div class="row h-100">
                ...
                <div class="col-md-5 my-auto pt-5 pt-md-0">
                    <h2 class="ttl-40 text-black fw-bold text-uppercase">Our green fleet</h2>
                    <p>“Emirates Transport is committed to a sustainable future with our growing green fleet, reducing emissions and promoting eco-friendly transportation solutions across the UAE.”</p>
