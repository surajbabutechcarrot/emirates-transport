...
<main class="inner-page">
    ...
    <section class="inner-banner school contact pt-0 d-flex align-items-center">
        <div class="container-fluid">
            <div class="banner-content text-center text-uppercase">
                <h1 class="fw-bold text-white">النقل المدرسي</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p class="text-gray">43 عامًا من التميز</p>
                    <h2 class="ttl-40 fw-bold text-black text-uppercase pb-4">خدماتنا بالأرقام</h2>
                </div>
            </div>
        </div>
        <div class="container-fluid px-5 pt-5 number-sec">
            <div class="row">
                <div class="col-lg-3 col-sm-6 col-6 p-lg-0">
                    <img src="<?php echo $path; ?>assets/images/numbers-1-ar.png">
                </div>
                <div class="col-lg-3 col-sm-6 col-6 p-lg-0">
                    <img src="<?php echo $path; ?>assets/images/numbers-2-ar.png">
                </div>
                <div class="col-lg-3 col-sm-6 col-6 p-lg-0">
                    <img src="<?php echo $path; ?>assets/images/numbers-3-ar.png">
                </div>
                <div class="col-lg-3 col-sm-6 col-6 p-lg-0">
                    <img src="<?php echo $path; ?>assets/images/numbers-4-ar.png">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="w-100 row we-care">
                    <div class="col-lg-12 text-center">
                        <h2 class="ttl-40 fw-bold pt-5 text-uppercase">نعتني بكل واحدٍ منكم</h2>
                    </div>
                    ...
                    <div class="col-lg-5 d-flex align-items-center">
                        <div class="text">
                            <p>تكرس مواصلات الإمارات جهودها لتمكين الطلبة من الفئات كافة، حيث تقدم حافلات مصممة خصيصًا لنقل الطلبة من ذوي الهمم، مما يضمن رحلة آمنة ومريحة إلى المدرسة ومنها. تعكس هذه المبادرة التزامنا بتوفير حلول نقل ميسرة تلبي الاحتياجات الفريدة لجميع الطلبة في الإمارات.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="std-space pt-0">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p class="text-gray">تقنياتنا</p>
                    <h3 class="ttl-30 fw-bold text-black text-uppercase">نحن نُمكّن كل رحلة من خلال التكنولوجيا المبتكرة</h3>
                </div>
            </div>
        </div>
        <div class="container-fluid px-5 pt-5">
            <div class="row">
                <div class="col-lg-3">
                    <div class="col-lg-12 pb-2 pb-lg-5">
                        <h3 class="fw-bold text-black">سائقون يركزون
                        على السلامة</h3>
                        <p>سائقونا المدربون بعناية ملتزمون بضمان سلامة رحلة كل طالب، مع إيلاء اهتمام بالغ لكل التفاصيل لخلق تجربة نقل آمنة، مريحة وخالية من القلق للطلبة وأولياء الأمور على حد سواء.</p>
                    </div>
                    <div class="col-lg-12 pt-2 pt-lg-5">
                        <h3 class="fw-bold text-black">مسارات ذكية لرحلات
                        سلسة</h3>              
                        <p>باستخدام تقنية التخطيط الذكي للمسارات، نقوم بتحسين كل رحلة لتقليل وقت السفر وزيادة الكفاءة إلى أقصى حد، مما يضمن وصول الطلبة بأمان وفي الوقت المحدد، مع تقليل الازدحام المروري والأثر البيئي.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="col-lg-12 pb-2 pb-lg-5">
                        <h3 class="fw-bold text-black">سائقون متيقظون</h3>
                        <p>مزودون بأحدث التقنيات؛ يتلقى سائقونا إشعارات فورية وفي الوقت الفعلي، مما يتيح لهم اتخاذ قرارات استباقية تعزز السلامة على الطريق وتضمن رحلة سلسة وآمنة لجميع الطلبة.</p>
                    </div>
                    <div class="col-lg-12 pt-2 pt-lg-5">
                        <h3 class="fw-bold text-black"></h3>
                        <p>حافلاتنا مزودة بأنظمة مراقبة متقدمة بزاوية 360°، مما يوفر مراقبة شاملة لضمان الأمان الكامل وراحة البال منذ لحظة الصعود حتى النزول.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row h-100">
                <div class="col-lg-12 h-100 text-center d-flex align-items-center justify-content-center">
                    <div class="text z-index-2">
                        <h2 class="fw-bold text-white ttl-40">ابــــدأ رحــــلــــتــــك الآن</h2>
                        <a href="<?php echo $path; ?>contact/"
                            class="btn py-3 px-5 btn-outline-light mt-4 fw-bold">تواصل معنا</a>
                    </div>
                </div>
            </div>
        </div>
